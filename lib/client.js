...
.pp-food{position:absolute;left:50%;top:-8px;transform:translateX(-50%);font-size:26px;line-height:1;pointer-events:none;z-index:4;animation:pp-food 1.2s ease-out forwards}
@keyframes pp-food{0%{opacity:0;transform:translate(-50%,10px) scale(.5) rotate(-15deg)}20%{opacity:1;transform:translate(-50%,-4px) scale(1.15) rotate(8deg)}45%{transform:translate(-50%,-8px) scale(1) rotate(-5deg)}100%{opacity:0;transform:translate(-50%,-30px) scale(.9) rotate(0deg)}}
...
`;
    ...
    function PhotoPetApp(props) {
      ...
      // 喂食: bounce + a floating snack + a rotating feeding line. The
      // floating 🍗 clears itself after the animation (~1.2s).
      ...
      useEffect(() => {
        if (foodFx === 0) return;
        const timer = window.setTimeout(() => setFoodFx(0), 1300);
      ...
      return React.createElement('div', {
        ...
        foodFx > 0 && React.createElement('div', { className: 'pp-food', key: 'food-' + foodFx }, '🍗'),
