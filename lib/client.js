...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    /** The 💩 burst on 喂食: 3 turds popping out of the mouth area, each
     * slightly smaller, drifting sideways and shrinking as it floats up. */
    const POOP_BURST = [
      { dx: -12, delay: 0.00, duration: 1.25, size: 22 },
      { dx: 4, delay: 0.13, duration: 1.45, size: 18 },
      { dx: 13, delay: 0.26, duration: 1.65, size: 15 },
    ];
...
.pp-food{position:absolute;left:50%;bottom:30%;line-height:1;pointer-events:none;z-index:4;opacity:0;animation:pp-food 1.25s ease-out forwards}
@keyframes pp-food{0%{opacity:0;transform:translate(-50%,5px) scale(.6)}14%{opacity:1;transform:translate(-50%,-1px) scale(1)}60%{opacity:1;transform:translate(-50%,-20px) scale(.72)}100%{opacity:0;transform:translate(-50%,-44px) scale(.38)}}
...
`;
    ...
    function PhotoPetApp(props) {
      ...
      // 喂食: bounce + a 💩 burst from the mouth (2–3 turds, shrinking as
      // they float up) + a rotating feeding line. The burst clears itself
      // after the longest animation (~1.9s).
